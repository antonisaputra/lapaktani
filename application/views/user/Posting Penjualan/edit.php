        ...
        <div class="card shadow py-4">
            ...
            <div class="card-body ms-5 me-5">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="mb-1 col-lg-5">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_produk" id="nama_produk_pesanan" class="form-control" aria-label="default input example" placeholder="Masukkan Nama Produk.." value="<?= $penjualan['nama_produk']; ?>">
                        ...
                        <div class="mb-1 col-lg-5">
                            <div class="mb-3">
                                ...
                                <input type="number" name="stok" id="jumlah_produk" class="form-control" value="<?= $penjualan['stok'] ?>" placeholder="Masukkan jumlah produk dalam satuan kg" aria-label="default input example">
                        ...
                        <div class="row">
                            <div class="mb-1 col-lg-5">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="harga" value="<?= $penjualan['harga_satuan']; ?>" id="harga" class="form-control" placeholder="Masukkan jumlah produk dalam satuan kg" aria-label="default input example">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="kategori" name="kategori" aria-label="Default select example">
                                        <?php foreach ($kategori as $row) : ?>
                                            <?php if ($row['id'] == $penjualan['id_kategori']) :  ?>
                    ...
                    <textarea name="detail" id="deskripsi_produk"><?= $penjualan['detail']; ?></textarea>
