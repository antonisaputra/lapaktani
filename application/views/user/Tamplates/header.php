...
<head>
    ...
    <link rel="icon" href="<?= base_url(); ?><?= base_url(); ?>assets/user/user/img/TONI.png">
    <title>Lapak Tani | Home</title>
            ...
            <div class="collapse navbar-collapse navbar-menu" id="navbarSupportedContent">
                ...
                <div class="dropdown dropdown-profil">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="keranjang.html">Keranjang Belanja</a></li>
                        <li><a class="dropdown-item" href="riwayattransakasi.html">Riwayat Transaksi</a></li>
                        <li><a class="dropdown-item" href="postingpesanan.html">Posting Pesanan</a></li>
                        <li><a class="dropdown-item" href="postingpenjualan.html">Posting Penjualan</a></li>
