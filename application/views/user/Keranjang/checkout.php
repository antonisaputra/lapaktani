                ...
                <form action="" method="POST">
                    <div class="mb-1 col-lg-10">
                        <div class="mb-3">
                            ...
                            <input type="text" name="username" id="nama" class="form-control" aria-label="default input example" value="<?= queryUser('username'); ?>" aria-label="Disabled input example" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="nohp">No.Handphone</label>
                            <input type="text" name="" id="nohp" class="form-control" aria-label="default input example" value="<?= queryUser('no_hp'); ?>" aria-label="Disabled input example" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="alamat" class="form-label">Alamat</label>
                            <input class="form-control" name="alamat" value="<?= queryUser('alamat'); ?>" id="alamat" aria-label="Disabled input example" disabled></input>
                        </div>
                        <h5>Pilih Motode Pembayaran</h5>
                        <?php foreach ($pembayaran as $row) : ?>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="bank" id="<?= $row['metode_pembayaran']; ?>">
                                <label class="form-check-label" for="<?= $row['metode_pembayaran']; ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="no_rek" id="nama" class="form-control" aria-label="default input example" value="<?= queryUser('username'); ?>">
                            <?= form_error('no_rek', '<small class="text-danger ms-3">', '</small>'); ?>
                        </div>
                        <h5>Pilih Kurir</h5>
                        <?php foreach ($kurir as $row) : ?>
                            <div class="form-check mt-1 mb-1">
                                <input class="form-check-input" type="radio" name="kurir" id="<?= $row['kurir']; ?>">
                                <label class="form-check-label" for="<?= $row['kurir']; ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="catatan_pembelian" id="catatanpembelian" rows="3"></textarea>
