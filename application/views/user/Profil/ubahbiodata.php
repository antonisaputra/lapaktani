                        ...
                        <div class="mb-1 col-lg-5">
                            <div class="mb-3">
                                ...
                                <input type="text" name="username" id="username" class="form-control"
                                    aria-label="default input example" value="<?= $user['username']; ?>">
                                <?= form_error('username','<small class="text-danger ms-3">','</small><br>') ?>
                            </div>
                            <div class="mb-3">
                                <label for="email">Email</label>
                                <input type="email" name="email" name="email" id="email" class="form-control" aria-label="default input example" value="<?= $user['email']; ?>">
