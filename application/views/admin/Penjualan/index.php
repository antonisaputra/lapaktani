  ...
  <div class="container-fluid px-0">
    <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
      <div class="d-flex align-items-center">
        <!-- Search form -->
        <form action="<?= base_url(); ?>Admin_penjualan" method="POST" class="navbar-search form-inline" id="navbar-search-main">
          <div class="input-group input-group-merge search-bar">
            <input type="text" class="form-control" name="keyword" id="topbarInputIconLeft" placeholder="Cari Produk Penjualan" aria-label="Search" aria-describedby="topbar-addon" autocomplete="off">
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
  <div class="btn-toolbar mb-2 mb-md-0">
    <div class="btn-group ms-2 ms-lg-3">
      <a href="<?= base_url(); ?>Admin_penjualan/print" class="btn btn-sm btn-outline-gray-600" target="_blank">Print</a>
    </div>
  </div>
</div>
    ...
    <tbody>
      ...
      <?php foreach ($penjualan as $row) : ?>
        <tr>
          ...
          <td><span class="fw-normal"><?= $row['nama_penjual']; ?></span></td>
          <td><span class="fw-normal"><?= $row['alamat_penjual']; ?></span></td>
          ...
          <td>
            <div class="btn-group">
              ...
              <div class="dropdown-menu py-0">
                <a class="dropdown-item rounded-top" href="<?= base_url(); ?>Admin_penjualan/detail/<?= $row['id']; ?>"><span class="fas fa-eye me-2"></span>Lihat Detail</a>
                <a class="dropdown-item" href="<?= base_url(); ?>Admin_penjualan/edit/<?= $row['id']; ?>"><span class="fas fa-edit me-2"></span>Edit</a>
                <a class="dropdown-item text-danger rounded-bottom tombol-hapus-kategori" href="<?= base_url(); ?>Admin_penjualan/hapus/<?= $row['id']; ?>"><span class="fas fa-trash-alt me-2"></span>Remove</a>
              </div>
            </div>
          </td>
        </tr>
