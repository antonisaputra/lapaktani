  ...
  <div class="container-fluid px-0">
    <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
      <div class="d-flex align-items-center">
        <!-- Search form -->
        <form action="<?= base_url(); ?>Admin_transaksi" method="POST" class="navbar-search form-inline" id="navbar-search-main">
          <div class="input-group input-group-merge search-bar">
            <input type="text" class="form-control" name="keyword" id="topbarInputIconLeft" placeholder="Cari Transaksi" aria-label="Search" aria-describedby="topbar-addon" autocomplete="off">
...
<div class="card card-body mt-3 border-0 shadow table-wrapper table-responsive">
    ...
    <tbody>
      ...
      <?php foreach ($transaksi as $row) : ?>
        <tr>
          ...
          <td><span class="fw-normal"><?= $row['metode_pembayaran']; ?></span></td>
          ...
          <td>
            <div class="btn-group">
              ...
              <div class="dropdown-menu py-0">
                <a class="dropdown-item rounded-top" href="<?= base_url(); ?>Admin_transaksi/detail/<?= $row['id']; ?>"><span class="fas fa-eye me-2"></span>Lihat Detail</a>
                <a class="dropdown-item text-danger rounded-bottom tombol-hapus-kategori" href="<?= base_url(); ?>Admin_keranjang/delete/<?= $row['id']; ?>"><span class="fas fa-trash-alt me-2"></span>Remove</a>
              </div>
            </div>
          </td>
        </tr>
