      ...
      <div class="d-flex align-items-center">
        ...
        <form action="" method="POST" class="navbar-search form-inline" id="navbar-search-main">
          <div class="input-group input-group-merge search-bar">
            <input type="text" class="form-control" name="keyword" id="topbarInputIconLeft" placeholder="Cari Pengiriman Barang" aria-label="Search" aria-describedby="topbar-addon" autocomplete="off">
  ...
  <table class="table table-hover">
    ...
    <tbody>
      ...
      <?php foreach ($proses_pengiriman as $row) : ?>
        <?php if($row['status_barang'] == "Proses"): ?>
        <tr>
          <td>
            <?= ++$start; ?>
          </td>
          ...
          <td>
            <div class="btn-group">
              ...
              <div class="dropdown-menu py-0">
                <a class="dropdown-item rounded-top" href="<?= base_url(); ?>Pengiriman/lanjut_pengiriman/<?= $row['id']; ?>"><span class="fas fa-eye me-2"></span>Lanjut Pengiriman</a>
              </div>
            </div>
          </td>
          <?php endif; ?>
