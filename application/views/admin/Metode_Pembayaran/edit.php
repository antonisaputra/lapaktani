                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <form action="" method="POST">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="metode_pembayaran" class="form-control" id="metode_pembayaran" value="<?= $pembayaran['metode_pembayaran']; ?>">
                                    <?= form_error('metode_pembayaran','<small class="form-text text-muted text-danger">','</small>')?>
                                </div>
                                <div class="mb-4">
                                    <label for="no_rekening">Nomor Rekening</label>
                                    <input type="text" name="no_rekening" class="form-control" id="no_rekening" value="<?= $pembayaran['no_rekening']; ?>">
