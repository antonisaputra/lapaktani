      ...
      <div class="d-flex align-items-center">
        ...
        <form action="" method="POST" class="navbar-search form-inline" id="navbar-search-main">
          <div class="input-group input-group-merge search-bar">
            <input type="text" class="form-control" name="keyword" id="topbarInputIconLeft" placeholder="Cari Metode Pembayaran" aria-label="Search" aria-describedby="topbar-addon" autocomplete="off">
...
?>
<a href="<?= base_url();?>Admin_metode_pembayaran/tambah" class="btn mt-3 mb-3 btn-gray-800 d-inline-flex align-items-center me-2 dropdown-toggle">
    ...
    <tbody>
      ...
      <?php foreach ($pembayaran as $row) : ?>
        <tr>
          ...
          <td><span class="fw-normal"><?= $row['no_rekening']; ?></span></td>
          <td>
            <div class="btn-group">
              ...
              <div class="dropdown-menu py-0">
                <a class="dropdown-item" href="<?= base_url(); ?>Admin_metode_pembayaran/edit/<?= $row['id']; ?>"><span class="fas fa-edit me-2"></span>Edit</a>
                <a class="dropdown-item text-danger rounded-bottom tombol-hapus-kategori" href="<?= base_url(); ?>Admin_metode_pembayaran/delete/<?= $row['id']; ?>"><span class="fas fa-trash-alt me-2"></span>Remove</a>
              </div>
            </div>
          </td>
        </tr>
