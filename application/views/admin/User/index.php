  ...
  <div class="container-fluid px-0">
    <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
      <div class="d-flex align-items-center">
        <!-- Search form -->
        <form action="<?= base_url(); ?>Admin_user" method="POST" class="navbar-search form-inline" id="navbar-search-main">
          <div class="input-group input-group-merge search-bar">
            <input type="text" class="form-control" name="keyword" id="topbarInputIconLeft" placeholder="Cari User" aria-label="Search" aria-describedby="topbar-addon" autocomplete="off">
...
<a href="<?= base_url();?>Admin_user/tambah_kurir" class="btn mt-3 mb-3 btn-gray-800 d-inline-flex align-items-center me-2 dropdown-toggle">
  ...
  <table class="table table-hover">
    <thead>
      <tr>
        ...
        <th class="border-gray-200">Usernama</th>
        <th class="border-gray-200">Tanggal Lahir</th>
        <th class="border-gray-200">Jenis Kelamin</th>
        <th class="border-gray-200">Email</th>
        <th class="border-gray-200">No Hp</th>
    ...
    <tbody>
      ...
      <?php foreach ($user as $row) : ?>
        <tr>
          ...
          <td><span class="fw-normal"><?= $row['tanggal_lahir']; ?></span></td>
          <td><span class="fw-normal"><?= $row['jenis_kelamin']; ?></span></td>
          <td><span class="fw-normal"><?= $row['email']; ?></span></td>
          <td><span class="fw-bold"><?= $row['no_hp']; ?></span></td>
          <td><span class="fw-bold"><?= $row['alamat']; ?></span></td>
          <td><span class="fw-bold"><?= $row['role']; ?></span></td>
          <td>
            <div class="btn-group">
              ...
              <div class="dropdown-menu py-0">
                <a class="dropdown-item text-danger rounded-bottom tombol-hapus-kategori" href="<?= base_url(); ?>Admin_user/hapus/<?= $row['id']; ?>"><span class="fas fa-trash-alt me-2"></span>Remove</a>
              </div>
            </div>
          </td>
        </tr>
